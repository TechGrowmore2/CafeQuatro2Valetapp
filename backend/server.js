...
const io = socketIo(server, {
  cors: {
    origin: process.env.FRONTEND_URL || "https://cafequattro2valetapp.onrender.com",
    methods: ["GET", "POST"],
    credentials: true,
  },
});
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        "connect-src": [
          ...
          "ws:",
          "https://api.brevo.com",
          // Allow both possible backend URLs (single-f frontend + double-f backend)
          "https://cafequattro2valetapp.onrender.com",
          "https://caffequattro2valetapp.onrender.com",
...
app.use(
  cors({
    origin: [process.env.FRONTEND_URL, process.env.ADMIN_PANEL_URL, "https://cafequattro2valetapp.onrender.com"].filter(Boolean),
    credentials: true,
  })
);
